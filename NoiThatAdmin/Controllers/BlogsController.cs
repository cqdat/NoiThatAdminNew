...
namespace NoiThatAdmin.Controllers
{
    public class BlogsController : Controller
    {
        ...
        {
            ViewBag.CatetoryID = new SelectList(db.Categories.Where(c=>c.TypeCate == WebConstants.CategoryNews), "CategoryID", "CategoryName");
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "BlogID,BlogName,ImageURL,Descript,Content,TypeBlog,CountView,IsActive,CatetoryID,Created,CreatedBy,SEOTitle,SEOUrlRewrite,SEOKeywords,SEOMetadescription")] Blog blog,
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "BlogID,BlogName,ImageURL,Descript,Content,TypeBlog,CountView,IsActive,CatetoryID,Created,CreatedBy,SEOTitle,SEOUrlRewrite,SEOKeywords,SEOMetadescription")] Blog blog,
            HttpPostedFileBase HinhAnh)
        {
            if (ModelState.IsValid)
            {
